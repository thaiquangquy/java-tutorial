...
// Concrete mediator. All chaotic communications between concrete components have been extracted to this class.
// Now components only communicates with the mediator, which knows who should handle a specific request.
public class Editor implements Mediator {
    ...
    public void createGUI() {
        ...
        save.setFont(new Font("Verdana", Font.PLAIN, 22));
